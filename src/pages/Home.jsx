    ...
    <div style={{ paddingTop: '0' }}>
      ...
      <section id="histoire" style={{ padding: '100px 20px', background: 'var(--kaia-cream)' }}>
        <div className="wrap" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '40px', alignItems: 'center' }}>
          <div>
            <img src="/kaia-logo-v3.png" alt="KAÏA SUNGLASSES" style={{ height: '52px', width: 'auto', filter: 'brightness(0) sepia(1) saturate(3) hue-rotate(120deg) brightness(0.3)' }} />
      ...
      <section id="savoir-faire" style={{ padding: '100px 20px', background: 'var(--kaia-cream)', color: 'var(--ink)' }}>
        <div className="wrap" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '60px', alignItems: 'center' }}>
          ...
          <div>
            ...
            <div style={{ width: '60px', height: '2px', background: 'var(--kaia-gold)', marginBottom: '24px' }}></div>
            ...
            <div style={{ background: '#fff', padding: '20px', borderRadius: '16px', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 8px 24px rgba(0,0,0,0.04)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', fontSize: '0.82rem', color: '#555', marginBottom: '14px' }}>
                ...
                <div>• Largeur verres : <strong>50 à 53 mm</strong></div>
                <div>• Protection solaires : <strong>UV400 Cat. 3</strong></div>
